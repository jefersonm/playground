...
Two middleware functions are provided by default in the `ilegra-library.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `ilegra-library.handler` namespace to manage the enabled middleware.
